...
export default function Shadow() {
  return (
    ...
    <Head>
      ...
      <article>
        <h2>The shadow</h2>
        <h3>Published 20 December 2020</h3>
        <h3>Updated 12 June 2021</h3>
...
<p>As Mark Manson has written, the best thing about a country is also the worst thing about a country. The U.S. is a great example that he touches on in various essays of his.</p>

<p>It’s a competitive, work-oriented society that produces huge amounts of innovation, wealth, and creative output. We all benefit. Its culture is the secret behind its political, cultural, and economic dominance. It’s also the cause of its opioid epidemics, mass shootings, high personal debt, and chronic unhealthiness. All of these are caused, I think, because Americans, in general, put career success and making money above everything else. The best thing is also the worst thing.</p>

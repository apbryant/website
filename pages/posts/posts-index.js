    ...
    <MyHeader />
      ...
      <Link href="/posts/learning-from-rap-lyrics">
        <a>Learning from rap lyrics</a>
					 ...
					 <div>
      <Link href="/posts/whats-missing-in-photos-of-presidents">
      ...
      <Link href="/posts/the-sidewalk-isnt-straight">
        <a>The sidewalk isn't straight</a>
			 ...
			 <div>
      <Link href="/posts/software-and-life">
        <a>Software and life</a>
      </Link>
      </div>
			 <div>
      <Link href="/posts/lets-see">
        <a>Let's see</a>
      </Link>
      </div>
	 ...
	 <div>
      <Link href="/posts/just-building-is-not-enough">
        <a>Just building is not enough</a>
      </Link>
      </div>

<div>
      <Link href="/posts/why-i-hang-out-on-trains">
      ...
      <div>
      <Link href="/posts/the-dose-makes-the-poison">
        <a>The dose makes the poison</a>
      </Link>
      </div>
      <div>
      ...
      <div>
      <Link href="/posts/how-does-art-happen">
        <a>How does art happen?</a>
      </Link>
      </div>
      <div>
